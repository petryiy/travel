...
export function PosterExportModal({ title, dataUrl, error, open, onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#2b2118]/60 px-4 py-6 backdrop-blur-sm">
      <div className="flex max-h-full w-full max-w-6xl flex-col overflow-hidden rounded-lg border border-[#c7b58e] bg-[#fffaf0] shadow-2xl">
        <div className="flex flex-wrap items-center justify-between gap-3 border-b border-[#dbcaa8] px-5 py-4">
          <div>
            <p className="text-xs font-bold uppercase text-[#6b8a64]">Export poster</p>
            <h2 className="font-serif text-2xl font-bold text-[#34271b]">Shareable travel journal</h2>
          </div>
        ...
        <div className="journal-desk min-h-0 flex-1 overflow-auto p-5">
          {error && (
